    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0056a3] to-slate-900 flex flex-col items-center justify-center p-6 font-sans text-slate-800">
      <div className="text-center mb-12 max-w-3xl mx-auto flex flex-col items-center">
        ...
        <div className="bg-white/10 backdrop-blur-sm p-4 rounded-2xl mb-6 shadow-lg border border-white/20">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-[#ffdd00] rounded-lg flex items-center justify-center text-[#0056a3]">
              <Zap size={22} fill="currentColor" />
            </div>
            <span className="text-2xl font-black text-white tracking-tight uppercase">SmartBot DMX</span>
          </div>
        </div>
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        ...
        <div className="group relative bg-white rounded-3xl p-8 md:p-10 shadow-2xl shadow-black/20 flex flex-col transition-all duration-300 hover:-translate-y-2 hover:shadow-3xl hover:shadow-[#ffdd00]/20 border-2 border-transparent hover:border-[#ffdd00]">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Dành cho Khách hàng trải nghiệm</h2>
          ...
          <button
            onClick={onEnterChat}
            className="w-full bg-[#ffdd00] hover:bg-[#ffea4d] text-slate-900 font-bold text-lg py-5 px-6 rounded-2xl shadow-lg shadow-[#ffdd00]/30 transition-all active:scale-[0.98] flex items-center justify-center gap-3"
          >
        ...
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-2xl shadow-black/20 flex flex-col relative overflow-hidden border-2 border-transparent">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Quản trị viên &amp; Cán bộ Nhân viên</h2>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={loggingIn}
              className="w-full bg-[#0056a3] hover:bg-[#004785] text-white font-bold text-lg py-5 px-6 rounded-xl shadow-lg shadow-[#0056a3]/30 transition-all active:scale-[0.98] mt-auto disabled:opacity-60"
            >
      ...
      <div className="mt-12 text-blue-200/60 text-sm text-center">
        <p>© 2026 Hệ sinh thái AI Điện Máy Xanh. Hệ thống được bảo mật theo tiêu chuẩn nội bộ.</p>
      </div>
    </div>
  );
}
